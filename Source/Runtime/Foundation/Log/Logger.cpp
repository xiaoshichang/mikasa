...
static char Buffer_[MAX_LOG_LEN];


void Logger::Init(const std::string& target, const std::string& fileName)
{
    InitLoggingCore();
...
void Logger::InitSink(const std::string& target, const std::string& fileName)
{
    // formatter
